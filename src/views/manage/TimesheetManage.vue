<template>
  <div class="list-table">
    <v-container grid-list-xl fluid class="ml-12">
      <v-layout row wrap>
        <v-flex sm12>
          <h3>Complex Table</h3>
        </v-flex>
...
import { Items as Users } from '@/api/mock/user'
import { Items as Timesheets } from '@/api/mock/timesheets'
export default {
  data() {
    return {
      formModel: {
