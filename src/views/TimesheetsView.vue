...
import WeeklyTable from '@/components/timesheets/WeeklyTable'
// import TimesheetPanels from '@/components/timesheets/TimesheetPanels'
...
// const TimecardsWeekTable = () => ({
//   component: import('@/components/timesheets/TimesheetsWeekTable'),
...
export default {
  ...
  computed: {
    // ...mapState('Timesheet', ['timesheets']),
    // ...mapState('callrecords', ['callrecords']),
    // ...mapState('users', ['callrecords']),
    // timesheets() {
