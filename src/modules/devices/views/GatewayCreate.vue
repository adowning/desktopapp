  ...
  <div class="gateway-create-view">
    ...
    <div class="gateway-card-details-body">
      <el-card>
        ...
        <el-row :gutter="50">
          <el-form ref="record" label-position="top" :model="record" :rules="rules">
            <!-- step 1 -->
            <div v-show="step === 1" class="gateways-rows">
              <el-col :span="12">
                <el-form-item prop="deviceName" :label="$t('gateways.gatewayName')">
                  <el-input v-model="record.deviceName" type="text" :placeholder="$t('gateways.gatewayNameRequired')">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item prop="longitude" :label="$t('devices.longitude')">
                  <el-input type="number" v-model.number="record.longitude" :disabled="false"> </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item prop="latitude" :label="$t('devices.latitude')">
                  <el-input type="number" v-model.number="record.latitude" :disabled="false"> </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
      ...
      <emq-button v-if="step === 2" icon="save" @click="save" :loading="btnLoading">
        {{ $t('oper.finish') }}
      </emq-button>
