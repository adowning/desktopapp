  ...
  <div class="details-view cert-details-view">
    ...
    <div class="certs-card-details-body">
      <el-card :class="disabled ? 'is-details-form' : ''">
        <edit-toggle-button :url="url" :disabled="disabled" :accessType="accessType" @toggleStatus="toggleStatus">
        </edit-toggle-button>
        <el-row :gutter="50">
          <el-form
            ref="record"
          ...
          >
            ...
            <el-col v-if="accessType === 'view'" :span="12">
              <el-form-item :label="$t('certs.createUser')">
                <el-input v-model="record.createUser" :disabled="disabled"> </el-input>
              </el-form-item>
            </el-col>
            <el-col v-if="accessType === 'view'" :span="12">
        ...
        <emq-button v-if="disabled" @click="downloadFile" style="float:none;margin:10px 0 0 0;">
      ...
      <add-device :url="url" :detailsID="parseInt(detailsID, 10)"> </add-device>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      url: '/certs',
      rules: {
        certName: [{ required: true, message: this.$t('certs.nameRequired'), trigger: 'blur' }],
        enable: [{ required: true, message: this.$t('certs.enableRequired'), trigger: 'blur' }],
      },
    }
  },
