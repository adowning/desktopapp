  ...
  <div class="details-view device-details-view">
    <emq-details-page-head>
      ...
      <div v-if="currentDevice" class="emq-tag-group" slot="tag">
        <emq-tag v-if="record.deviceStatusLabel" :class="record.deviceStatus === 1 ? 'online' : 'offline'">
    ...
    <client-details :disabled="disabled" :loading="loading" :record="record" @toggleStatus="showDetails">
      <template v-slot:detailsForm="{ lang }">
        <el-row :gutter="20">
          ...
          >
            ...
            <!-- Uplink system -->
            <el-col :span="12">
              <el-form-item prop="upLinkSystem" :label="$t('devices.upLinkSystem')">
                <emq-select
            ...
            <!-- Parent device -->
            <el-col
              v-if="record.upLinkSystem === Device && record.cloudProtocol !== $variable.cloudProtocol.LWM2M"
              :span="12"
            >
            ...
            <el-col
              v-if="record.upLinkSystem === Gateway && record.cloudProtocol !== $variable.cloudProtocol.LORA"
              :span="12"
            >
            ...
            <el-col :span="12">
              <el-form-item prop="description" :label="$t('devices.description')">
                <el-input type="text" v-model="record.description" :disabled="disabled"> </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop="serialNumber" :label="$t('devices.serialNumber')">
                <el-input type="text" v-model="record.serialNumber" :disabled="disabled"> </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop="softVersion" :label="$t('devices.softVersion')">
                <el-input type="text" v-model="record.softVersion" :disabled="disabled"> </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop="hardwareVersion" :label="$t('devices.hardwareVersion')">
                <el-input type="text" v-model="record.hardwareVersion" :disabled="disabled"> </el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="12">
              <el-form-item prop="manufacturer" :label="$t('devices.manufacturer')">
                <el-input type="text" v-model="record.manufacturer" :disabled="disabled"> </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop="metaData" :label="$t('devices.metaData')">
                ...
                <div v-else class="link">
                  <a href="javascript:;" style="float: none;">
            ...
            <el-col v-if="disabled" :span="12">
              <el-form-item prop="createAt" :label="$t('devices.createAt')">
                <el-input type="text" v-model="record.createAt" :disabled="disabled"> </el-input>
              </el-form-item>
            </el-col>
            <el-col v-if="disabled" :span="12">
              <el-form-item prop="createUser" :label="$t('devices.createUser')">
                <el-input type="text" v-model="record.createUser" :disabled="disabled"> </el-input>
              </el-form-item>
            </el-col>
          </el-form>
        </el-row>
        <div v-if="!disabled" class="btn-bar">
          ...
          <el-button type="text" size="small" style="float: right;" @click="showDetails('view')">
            {{ $t('oper.cancel') }}
          </el-button>
        </div>
      </template>
    ...
    >
      ...
      <code-editor lang="application/json" theme="lesser-dark" v-model="tempMetaData" :disabled="disabled">
      </code-editor>
    </emq-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    loadData() {
      ...
      httpGet(`${this.url}/${this.deviceIntID}`)
        .then(res => {
