  ...
  <div class="details-view group-details-view">
          ...
          >
            ...
            <el-col v-if="accessType === 'view'" :span="12">
              <el-form-item :label="$t('groups.createUser')">
                <el-input v-model="record.username" :disabled="disabled"> </el-input>
              </el-form-item>
            </el-col>
            <el-col v-if="accessType === 'view'" :span="12">
    ...
    >
      ...
      <div class="create-success__oper">
        <el-button class="add-button" @click="createGroup">
          {{ $t('groups.addDevice') }}
        </el-button>
        <el-button class="cancel" @click="backGroups">
          {{ $t('groups.addCancel') }}
        </el-button>
      </div>
    </el-dialog>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        productID: [{ required: true, message: this.$t('groups.productIDRequired'), trigger: 'blur' }],
      },
    }
  },
