  ...
  <div class="devices-create-view">
    ...
    <div class="devices-card-details-body">
      <el-card>
        ...
        <el-row :gutter="50">
          <el-form ref="record" label-position="top" :model="record" :rules="deviceInfoRules">
            <!-- step 1 -->
            <div v-show="step === 1" class="devices-rows">
              <el-col :span="12">
                <el-form-item prop="deviceName" :label="$t('devices.deviceName')">
                  <el-input v-model="record.deviceName" type="text" :placeholder="$t('devices.deviceNameRequired')">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <span v-if="has('POST,/products') && !$route.query.productID" class="create-button">
                  {{ $t('devices.or') }}
              ...
              <el-col
                class="parent-device"
                v-if="record.upLinkSystem === Device && cloudProtocol !== $variable.cloudProtocol.LWM2M"
                :span="12"
              >
              ...
              <el-col class="gateway" v-if="record.upLinkSystem === Gateway" :span="12">
              ...
              <el-col v-if="cloudProtocol === $variable.cloudProtocol.LWM2M" class="IMEI" :span="12">
              ...
              <el-col v-if="cloudProtocol === $variable.cloudProtocol.LWM2M" :span="12">
              ...
              <el-col :span="12">
                <el-form-item prop="manufacturer" :label="$t('devices.manufacturer')">
                  <el-input v-model="record.manufacturer" type="text" :placeholder="$t('devices.manufacturerRequired')">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item prop="serialNumber" :label="$t('devices.serialNumber')">
                  <el-input v-model="record.serialNumber" type="text" :placeholder="$t('devices.serialNumberRequired')">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item prop="softVersion" :label="$t('devices.softVersion')">
                  <el-input v-model="record.softVersion" type="text" :placeholder="$t('devices.softVersionRequired')">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item prop="description" :label="$t('devices.description')">
                  <el-input v-model="record.description" type="text" :placeholder="$t('devices.descriptionRequired')">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item prop="longitude" :label="$t('devices.longitude')">
                  <el-input type="number" v-model.number="record.longitude"> </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item prop="latitude" :label="$t('devices.latitude')">
                  <el-input type="number" v-model.number="record.latitude"> </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item prop="metaData" :label="$t('devices.metaData')">
                  <el-input type="text" v-model="record.metaData" @focus="metaDataVisible = true"> </el-input>
                </el-form-item>
              </el-col>
            ...
            <div v-if="step === 2" class="devices-rows">
              ...
              <el-col v-if="record.authType === Cert" :span="12">
                <span v-if="has('POST,/certs')" class="create-button">
                  {{ $t('devices.or') }}
                  ...
                  <div v-else-if="record.loraData.type === 'otaa'">
                    ...
                    <el-col class="token" :span="12">
                      <el-form-item prop="token" label="token">
                        <el-input v-model="record.token" type="text" :placeholder="$t('devices.deviceIDRequired')">
                        </el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="12">
        ...
        >
          ...
          <code-editor lang="application/json" theme="lesser-dark" v-model="tempMetaData"> </code-editor>
        </emq-dialog>
      </el-card>

      <emq-button v-if="step === 2" class="save" icon="save" :loading="btnLoaing" @click="save">
        {{ $t('oper.finish') }}
      </emq-button>

      <emq-button v-if="step === 1" class="next-step" @click="handleStep">
        {{ $t('devices.nextStep') }}
      </emq-button>

      <a v-if="step === 2" class="back-setup" href="javascript:;" @click="handleStep(false)">
        &lt;&lt; {{ $t('devices.backStep') }}
      </a>
    </div>

    <location-select-dialog ref="locationSelect" :confirm="locationSelectConfirm"> </location-select-dialog>
  </div>
</template>
...
import EmqSelect from '@/modules/common/EmqSelect'
...
export default {
  ...
  data() {
    return {
      ...
      deviceInfoRules: {
        deviceName: [{ required: true, message: this.$t('devices.deviceNameRequired') }],
        productID: [{ required: true, message: this.$t('devices.productNameRequired') }],
        ...
        upLinkSystem: [{ required: true, message: this.$t('devices.upLinkSystemRequired') }],
        parentDevice: [{ required: true, message: this.$t('devices.parentDeviceRequired') }],
        gateway: [{ required: true, message: this.$t('devices.gatewayRequired') }],
        lwm2mData: {
          autoSub: [{ required: true, message: this.$t('devices.autoSubRequired') }],
          IMSI: [
        ...
        authType: [{ required: true, message: this.$t('devices.authTypeRequired') }],
  ...
  methods: {
    ...
    handleTypeSelected(_type) {
      ...
      if (type === 'otaa') {
        ...
        this.deviceInfoRules.token = [{ min: 8, max: 36, message: this.$t('devices.len8to36'), trigger: 'change' }]
      }
    },
