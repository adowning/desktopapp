<template>
  <div class="create-product-view">
    <emq-dialog :title="$t('products.createProduct')" :visible.sync="visible" width="40%" @confirm="save">
      <el-form ref="record" :rules="rules" :model="record">
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item :label="$t('products.productName')" prop="productName">
              <el-input type="text" :placeholder="$t('products.productNameRequired')" v-model="record.productName">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item :label="$t('products.productDescription')" prop="description">
              <el-input type="textarea" :placeholder="$t('products.descriptionRequired')" v-model="record.description">
              </el-input>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  data() {
    return {
      record: {},
      rules: {
        productName: [{ required: true, message: this.$t('products.productNameRequired'), trigger: 'blur' }],
        cloudProtocol: [{ required: true, message: this.$t('products.cloudProtocolRequired'), trigger: 'blur' }],
        productType: [{ required: true, message: this.$t('products.productTypeRequired'), trigger: 'blur' }],
        gatewayProtocol: [{ required: true, message: this.$t('products.gatewayProtocolRequired'), trigger: 'blur' }],
      },
    }
  },
