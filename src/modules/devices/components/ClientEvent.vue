  ...
  <div class="details-view clients-details-events-view">
    ...
    >
      ...
      <template slot="tableColumns">
        <el-table-column prop="dataTypeLabel" width="90px" :label="$t('events.dataTypeLabel')"> </el-table-column>
        <el-table-column prop="streamID" width="120px" :label="$t('dataStreams.streamID')"> </el-table-column>
        <el-table-column prop="topic" width="150px" :label="$t('events.topic')"> </el-table-column>
        ...
        <el-table-column prop="responseResult" width="120px" :label="$t('events.responseResult')"> </el-table-column>
        <el-table-column prop="msgTime" width="160px" :label="$t('events.createAtLog')"> </el-table-column>
      </template>
    </emq-crud>
  </div>
</template>
